...
function Fileds() {
  const schema = yup.object().shape({
    ...
    earlyDepartureCost: yup.number().required('Early Departure Cost is required'),
      ...
      {({ handleSubmit, handleChange, values, touched, errors }) => (
        <Form noValidate onSubmit={handleSubmit}>
          ...
          <Row className="mb-3">
            ...
            <Form.Group as={Col} md="4" controlId="validationFormikEventDate">
          ...
          <Row className="mb-3">
            <Form.Group as={Col} md="4" controlId="validationFormikCheckInDate">
            ...
            <Form.Group as={Col} md="4" controlId="validationFormikCheckOutDate">
            ...
            <Form.Group as={Col} md="4" controlId="validationFormikCheckInTime">
          ...
          <Row className="mb-3">
            <Form.Group as={Col} md="4" controlId="validationFormikCheckOutTime">
            ...
            <Form.Group as={Col} md="4" controlId="validationFormikEarlyCheckInTime">
            ...
            <Form.Group as={Col} md="4" controlId="validationFormikLateCheckOutTime">
          ...
          <Row className="mb-3">
            {/* 4th Row */}
            <Form.Group as={Col} md="4" controlId="validationFormikCutOffDate">
            ...
            <Form.Group as={Col} md="4" controlId="validationFormikCutOffCost">
            ...
            <Form.Group as={Col} md="4" controlId="validationFormikEarlyDepartureCost">
          ...
          <Row className="mb-3">
            {/* 5th Row */}
            <Form.Group as={Col} md="4" controlId="validationFormikRoomRate">
            ...
            <Form.Group as={Col} md="4" controlId="validationFormikEarlyCheckInRate">
            ...
            <Form.Group as={Col} md="4" controlId="validationFormikLateCheckOutFee">
          ...
          <Row className="mb-3">
            {/* 6th Row */}
            <Form.Group as={Col} md="4" controlId="validationFormikChargeOfExtraPersons">
